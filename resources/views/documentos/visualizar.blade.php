...
<div class="col-6" style="margin-top: 6rem;">
		<a href="{{asset('imgPublications/'.$documento->imgUrl)}}" target="_blank"> <img  src=" @if($documento->imgUrl!=null) {{asset('imgPublications/'.$documento->imgUrl)}} @else {{asset('imgPublications/'.$documento->imgUrl2)}} @endif " class="img-fluid" alt="Responsive image" style="padding: 0rem;
