...
<div class="col-6" style="margin-top: 6rem;">
		<a href="{{asset('imgPublications/'.$documento->imgUrl)}}" target="_blank"> <img  src="{{asset('imgPublications/'.$documento->imgUrl)}}" class="img-fluid" alt="Responsive image" style="padding: 0rem;
																																																 width: 600px;
																																																 height: 300px;	
																																																 border-radius: 10%;		"></a>
			<div style="text-align: center; margin-top: 40px;">
				<a class="btn btn-success" href="{{url('admin/documentos/editar/'.$documento->id)}}" style="margin-right: 90px;
																											margin-top: 30px;					">Editar Datos</a>
